...
def try_to_populate_county(address: Address, force: bool = False) -> None:
    ...
    if (
        not hasattr(address, "location")
        or not hasattr(address.location, "latitude")
        or not address.location.latitude
    ):
        try:
            address.geocode()
        except:
    ...
    try:
        ...
        return
    try:
        for item in geocoder.geocoder.reverse(
...
def _load_ma_zip_data() -> Mapping[str, Mapping[str, Any]]:
    ...
    if path is None:
        path = os.path.join(
            os.path.dirname(__file__), "data", "sources", "ma_zip_codes.json"
        )
...
class MACourtList(DAList):
    ...
    def matching_courts(
        ...
        if address is None:
            if not addresses:
                return []
        elif isinstance(address, Iterable) and not isinstance(
            address, (Address, str, bytes)
        ):
            for add in address:
    ...
    def matching_courts_single_address(
        self,
        address: Address,
        court_types: Optional[Union[str, typing.Iterable[str]]] = None,
    ) -> List[MACourt]:
    ...
    def load_courts(
        self,
        courts=["housing_courts", "bmc", "district_courts", "superior_courts"],
    ...
    def load_courts_from_file(
        self, court_name, data_path="docassemble.MACourts:data/sources/"
    ):
                ...
                courts.update(
                    set(
                        [
                            ...
                            if court.name.rstrip().lower() == court_item.lower()
                        ]
                    )
                )
            return courts
    ...
    def matching_juvenile_court_name(self, address, depth=0) -> Set[str]:
        if (
            depth == 1
            and hasattr(address, "norm_long")
            and hasattr(address.norm_long, "city")
            and hasattr(address.norm_long, "county")
        ):
            address_to_compare = address.norm_long
        else:
            address_to_compare = address
        if (not hasattr(address_to_compare, "county")) or (
            address_to_compare.county.lower().strip() == ""
        ):
        ...
        if address_to_compare.city.lower() in [
            ...
            hasattr(address_to_compare, "neighborhood")
            and (
                (address_to_compare.city.lower() == "boston")
                and address_to_compare.neighborhood.lower()
                in [
                    "east boston",
                    "central square",
                    "day square",
    ...
    def matching_probate_and_family_court_name(self, address, depth=0) -> Set[str]:
        ...
        if (address_to_compare.county.lower() == "barnstable county") or (
        ...
        if (address_to_compare.county.lower() == "berkshire county") or (
            address_to_compare.city.lower()
            in [
                "adams",
                "alford",
        ...
        if (address_to_compare.county.lower() == "bristol county") or (
            address_to_compare.city.lower()
            in [
                "acushnet",
                "attleboro",
        ...
        if (address_to_compare.county.lower() == "dukes county") or (
            address_to_compare.city.lower()
            in [
                "aquinnah",
                "chilmark",
        ...
        if (address_to_compare.county.lower() == "essex county") or (
            address_to_compare.city.lower()
            in [
                "amesbury",
                "andover",
            ...
            matches.extend(
                ["Essex Probate and Family Court", "Lawrence Probate and Family Court"]
            )
        if (address_to_compare.county.lower() == "franklin county") or (
            address_to_compare.city.lower()
            in [
                "ashfield",
                "bernardston",
        ...
        if (address_to_compare.county.lower() == "hampden county") or (
            address_to_compare.city.lower()
            in [
                "agawam",
                "blandford",
        ...
        if (address_to_compare.county.lower() == "hampshire county") or (
            address_to_compare.city.lower()
            in [
                "amherst",
                "belchertown",
        ...
        if (address_to_compare.county.lower() == "middlesex county") and (
            address_to_compare.city.lower()
            in [
                "arlington",
                "belmont",
        ...
        if (address_to_compare.county.lower() == "nantucket county") or (
            address_to_compare.city.lower() in ["nantucket"]
        ):
            matches.append("Nantucket Probate and Family Court")
        if (address_to_compare.county.lower() == "norfolk county") or (
            address_to_compare.city.lower()
            in [
                "avon",
                "bellingham",
        ...
        if (address_to_compare.county.lower() == "plymouth county") or (
            address_to_compare.city.lower()
            in [
                "abington",
                "bridgewater",
        ...
        if (address_to_compare.county.lower() == "suffolk county") or (
            address_to_compare.city.lower()
            in ["boston", "chelsea", "revere", "winthrop"]
        ):
            matches.append("Suffolk Probate and Family Court")
        if (address_to_compare.county.lower() == "worcester county") or (
            address_to_compare.city.lower()
            in [
                "ashburnham",
                "athol",
    ...
    def matching_superior_court_name(self, address: Address, depth=0) -> str:
        ...
        elif (address_to_compare.county.lower() == "berkshire county") or (
            address_to_compare.city.lower()
            in [
                "adams",
                "alford",
        ...
        elif (address_to_compare.county.lower() == "bristol county") or (
            address_to_compare.city.lower()
            in [
                "acushnet",
                "attleboro",
        ...
        elif (address_to_compare.county.lower() == "dukes county") or (
            address_to_compare.city.lower()
            in [
                "aquinnah",
                "chilmark",
        ...
        elif (address_to_compare.county.lower() == "essex county") or (
            address_to_compare.city.lower()
            in [
                "amesbury",
                "andover",
        ...
        elif (address_to_compare.county.lower() == "franklin county") or (
            address_to_compare.city.lower()
            in [
                "ashfield",
                "bernardston",
        ...
        elif (address_to_compare.county.lower() == "hampden county") or (
            address_to_compare.city.lower()
            in [
                "agawam",
                "blandford",
        ...
        elif (address_to_compare.county.lower() == "hampshire county") or (
            address_to_compare.city.lower()
            in [
                "amherst",
                "belchertown",
        ...
        elif (address_to_compare.county.lower() == "middlesex county") or (
            address_to_compare.city.lower()
            in [
                "acton",
                "arlington",
        ...
        elif (address_to_compare.county.lower() == "nantucket county") or (
            address_to_compare.city.lower() in ["nantucket"]
        ):
            local_superior_court = "Nantucket County Superior Court"
        elif (address_to_compare.county.lower() == "norfolk county") or (
            address_to_compare.city.lower()
            in [
                "avon",
                "bellingham",
        ...
        elif (address_to_compare.county.lower() == "plymouth county") or (
            address_to_compare.city.lower()
            in [
                "abington",
                "bridgewater",
        ...
        elif (address_to_compare.county.lower() == "suffolk county") or (
            address_to_compare.city.lower()
            in ["boston", "chelsea", "revere", "winthrop"]
        ):
            local_superior_court = "Suffolk County Superior Court"
        elif (address_to_compare.county.lower() == "worcester county") or (
            address_to_compare.city.lower()
            in [
                "ashburnham",
                "athol",
    ...
    def matching_land_court(self, address: Address) -> Optional[MACourt]:
        ...
        return next(
            (
                court
                for court in self.elements
                if court.name.rstrip().lower() == "land court"
            ),
            None,
        )
    ...
    def matching_appeals_court(self, address: Address) -> Optional[MACourt]:
        ...
        return next(
            (
                ...
                == "massachusetts appeals court (single justice)"
            ),
            None,
        )
    ...
    def matching_supreme_judicial_court(self, address: Address) -> Optional[MACourt]:
        ...
        return next(
            (
                court
                for court in self.elements
                if court.name.rstrip().lower() == "supreme judicial court"
            ),
            None,
        )
    ...
    def matching_housing_court_name(self, address: Address, depth=0) -> str:
        ...
        #    address_to_compare = address
        address_to_compare = (
            address  # don't normalize -- this screws up some addresses in small towns
        )
        if (not hasattr(address_to_compare, "county")) or (
            address_to_compare.county.lower().strip() == ""
        ):
        ...
        if (address_to_compare.city.lower()) in [
            ...
            address_to_compare.city.lower() in ["brookline"]
        ):
        ...
        elif address_to_compare.county.lower() in [
            "barnstable county",
            "dukes county",
            "nantucket county",
        ]:
    ...
    def matching_bmc(self, address: Address) -> Optional[MACourt]:
        if address.city.lower() in ["winthrop"]:
            ...
            try:
                court_name = (
                    self.get_boston_ward_number(address)[1]
    ...
    def load_boston_wards_from_file(
        self, json_path, data_path: Optional[str] = None
    ) -> GeoDataFrame:
        ...
        if data_path is None:
            if hasattr(self, "data_path"):
                ...
                data_path = "docassemble.MACourts:data/sources/"
        path = path_and_mimetype(os.path.join(self.data_path, json_path + ".geojson"))[
            0
        ]
        if path is None:
    ...
    def get_boston_ward_number(self, address: Address) -> Tuple[str, str]:
        ...
        # if location is in Boston, lookup ward
            ...
            ward = boston_wards[
                [p1.within(boston_wards.geometry[i]) for i in range(len(boston_wards))]
            ]
            ...
            # else find closest ward and return result
                ...
                distances_to_wards = [
                    p1.distance(boston_wards.iloc[i].geometry)
                    for i in range(len(boston_wards))
                ]
    ...
    _find_court_code_re = re.compile(
        r"(?<=^\d{2})(\d{2}|H\d{2})(?!-)|^[A-Z]{2}" r"(?=\d{2})", re.I
    )
        ...
        if not court_code:
            for key in self._land_court_case_type_code_dict:
                ...
                if not self._any_numbers_re.search(docket_number):
                    raise KeyError(
                        f"{docket_number} doesn't have any number digits in it, it's not likely a docket number"
                    )
                ...
                for key, name in self._appellate_court_code_dict.items():
                    if key in docket_number.upper():
                        matching_courts = [
                            court
                            for court in self.elements
                            if name.lower() in court.name.rstrip().lower()
                        ]
                        if matching_courts:
                            return matching_courts
                else:
                    raise KeyError(
                        f"{docket_number} doesn't have a court code, and isn't an appellate case, might be a variant"
                    )
            ...
            if not matching_courts:
                raise KeyError(
                    f"{court_code} (i.e. {search_court_code}) (from {docket_number}) isn't a valid court code"
                )
            return matching_courts
    ...
    def court_from_docket_number(self, docket_number: str) -> Optional[MACourt]:
        ...
        court = MACourt()
        court.name = (
            matching_courts[0].name
            if len(set([c.name for c in matching_courts])) == 1
            else None
        )
        court.court_code = (
            matching_courts[0].court_code
            if len(set([c.court_code for c in matching_courts])) == 1
            else None
        )
        court.tyler_code = (
            matching_courts[0].tyler_code
            if len(set([c.tyler_code for c in matching_courts])) == 1
            else None
        )
        court.description = (
            matching_courts[0].description
            if len(set([c.description for c in matching_courts])) == 1
            else None
        )
        if (
            court.name is None
            and court.court_code is None
            and court.description is None
        ):
            return None
        return court
...
find_year_re = re.compile(
    r"^\d{2}(?=\d{2}[A-Z]|H|\s)|(?<=^[A-Z]{2})\d{2}|" r"\d{4}(?=-)|\d{2}(?=-)", re.I
)
...
def combined_locations(locations):
    ...
    def match(item, other) -> bool:
        if not item is None and not other is None:
            return round(item.location.latitude, 3) == round(
                other.location.latitude, 3
            ) and round(item.location.longitude, 3) == round(
                other.location.longitude, 3
            )
        return False
            ...
            if not has_match(places, location):
                places.append(
                    MAPlace(
                        ...
                        address=copy.deepcopy(location.address),
                ...
                for place in places:
                    if match(place, location):
                        if (
                            hasattr(place, "description")
                            and str(location) not in place.description
                        ):
